    ...
    <div class="modal-content">
        ...
        <form id="categoryForm" action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" name="image" id="category_image_input" class="form-control" accept="image/*">
                <div id="category_image_preview" style="margin-top: 12px; display: none;">
                    ...
                    <img id="category_image_preview_img" src="" alt="Image preview" style="max-width: 100%; max-height: 300px; border-radius: 8px; border: 1px solid var(--traveloka-border, #e4ecf7); object-fit: contain; background: #f8f9fa;">
                </div>
            </div>
        </form>
    ...
    <div class="modal-content">
        ...
        <form id="editCategoryForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" name="image" id="edit_category_image_input" class="form-control" accept="image/*">
                <div style="margin-top: 12px;">
                    <div id="edit_category_current_image_container" style="margin-bottom: 12px; display: none;">
                        ...
                        <img id="edit_category_current_image" src="" alt="Current image" style="max-width: 100%; max-height: 300px; border-radius: 8px; border: 1px solid var(--traveloka-border, #e4ecf7); object-fit: contain; background: #f8f9fa;">
                    </div>
                    <div id="edit_category_new_image_preview" style="display: none;">
                        ...
                        <img id="edit_category_new_image_preview_img" src="" alt="New image preview" style="max-width: 100%; max-height: 300px; border-radius: 8px; border: 1px solid var(--traveloka-border, #e4ecf7); object-fit: contain; background: #f8f9fa;">
                    </div>
                </div>
            </div>
        </form>
