...
<div class="max-w-2xl mx-auto py-8 px-4">
    <div class="glass-card rounded-3xl p-8 text-center">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-slate-800 mb-2">{{ __('common.payment_success') }}</h1>
            <p class="text-slate-600">{{ __('common.payment_success_message') }}</p>
        </div>
        ...
        <div class="mb-6 p-6 bg-slate-50 rounded-xl text-left">
            ...
            <div class="space-y-2 text-sm">
                ...
                <div class="flex justify-between">
                    <span class="text-slate-600">{{ __('common.participants') }}:</span>
                    <span class="font-semibold text-slate-800">{{ $booking->num_participants }}</span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-slate-800">{{ $payment->transaction_id ?? 'N/A' }}</span>
                </div>
            </div>
        </div>
        @endif
